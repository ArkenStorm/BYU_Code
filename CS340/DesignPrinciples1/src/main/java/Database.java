...
1. What design principles does this code violate?
        Single Responsibility Principle, and swallows an exception

2. Without actually doing so, explain how you would refactor this code to improve its design.
        I would separate out the database accesses into a different class, and have course, offering, and schedule all
        utilize the database. I would also handle the error, either by printing an error message or throwing the
        exception to the parent for handling.
