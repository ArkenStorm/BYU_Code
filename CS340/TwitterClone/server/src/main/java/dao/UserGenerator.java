...
public class UserGenerator {
    ...
    static final String MALE_IMAGE_URL = "https://vignette.wikia.nocookie.net/leagueoflegends/images/3/3a/Demacia_profileicon.png/revision/latest/scale-to-width-down/340?cb=20170504232501";
    private static final String FEMALE_IMAGE_URL = "https://cdn.vox-cdn.com/thumbor/Fhjk_lDGX90sZBHy9MM1JEA_m4U=/1400x0/filters:no_upscale()/cdn.vox-cdn.com/uploads/chorus_asset/file/10587693/3382.jpg";
    ...
    public List<User> generateUsers(int count) {
        ...
        //users.add(LoginServiceProxy.getInstance().getCurrentUser()); // change to just a random user?
