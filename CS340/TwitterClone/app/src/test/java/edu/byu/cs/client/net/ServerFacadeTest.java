...
class ServerFacadeTest {
    ...
    void setup() {
        ...
        Mockito.when(mockFollowGenerator.generateFollowsForUsers(Mockito.anyList(), Mockito.anyInt(), Mockito.anyInt(), (FollowGenerator.Sort) Mockito.any())).thenReturn(follows);
