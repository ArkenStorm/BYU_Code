		...
		if (MEMWORD(rpt + TASK_RPT) || MEMWORD(rpt + TASK_RPT + 1)) {
			...
			for (upt = 0; upt < 64; upt += 2) {
				if (DEFINED(MEMWORD(rpt + TASK_RPT)) &&
					(DEFINED(MEMWORD((FRAME(MEMWORD(rpt + TASK_RPT)) << 6) + upt)) || PAGED(MEMWORD((FRAME(MEMWORD(rpt + TASK_RPT)) << 6) + upt + 1)))) {
...
// ---------------------------------------------------------------------
// **************************************************************************
int P4_test4(int argc, char* argv[]) {
	char* thingim[] = { "im", "8" };
	printf("\nim 8");
	P4_initMemory(2, thingim);

	char* thing[] = { "vma", "0x3000" };
	printf("\n0x3000");
	P4_vmaccess(2, thing);

	char* thing2[] = { "vma", "0x3001" };
	printf("\n0x3001");
	P4_vmaccess(2, thing2);

	char* thing3[] = { "vma", "0x3040" };
	printf("\n0x3040");
	P4_vmaccess(2, thing3);

	char* thing4[] = { "vma", "0x3041" };
	printf("\n0x3041");
	P4_vmaccess(2, thing4);

	char* thing5[] = { "vma", "0xEFD2" };
	printf("\n0xEFD2");
	P4_vmaccess(2, thing5);

	char* thing6[] = { "vma", "0xd851" };
	printf("\n0xd851");
	P4_vmaccess(2, thing6);

	char* thing7[] = { "vma", "0xd833" };
	printf("\n0xD833");
	P4_vmaccess(2, thing7);

	char* thing8[] = { "vma", "0x3873" };
	printf("\n0x3873");
	P4_vmaccess(2, thing8);

	char* thing9[] = { "vma", "0x3000" };
	printf("\n0x3000");
	P4_vmaccess(2, thing9);

	char* thing10[] = { "vma", "0xf7c5" };
	printf("\n0xF7C5");
	P4_vmaccess(2, thing10);

	char* thing11[] = { "vma", "0xeff0" };
	printf("\n0xEFF0");
	P4_vmaccess(2, thing11);

	char* thing12[] = { "vma", "0xd807" };
	printf("\n0xD807");
	P4_vmaccess(2, thing12);

	char* thing13[] = { "vma", "0x3040" };
	printf("\n0x3040");
	P4_vmaccess(2, thing13);

	char* thing14[] = { "vma", "0xffc8" };
	printf("\n0xFFC8");
	P4_vmaccess(2, thing14);

	char* thing15[] = { "vma", "0x303c" };
	printf("\n0x303C");
	P4_vmaccess(2, thing15);

	char* thing16[] = { "vma", "0xf000" };
	printf("\n0xF000");
	P4_vmaccess(2, thing16);
